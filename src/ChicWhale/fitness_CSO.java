...
import static ChicWhale.run.VM_Migration_update;
import static ChicWhale.run.st;
import static ChicWhale.run.p;
import static ChicWhale.run.load;
import static ChicWhale.run.resource_utilization;
import static ChicWhale.run.resource_utilization_C;
import static ChicWhale.run.resource_availability;
import static ChicWhale.run.migration_cost;
import static ChicWhale.run.energy;
