...
import static Quokka.run.st;
import static Quokka.run.p;
import static Quokka.run.load;
import static Quokka.run.resource_utilization;
import static Quokka.run.resource_utilization_C;
import static Quokka.run.resource_availability;
import static Quokka.run.migration_cost;
import static Quokka.run.energy;

public class fitness_QA {
